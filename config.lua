...
function Config:CreateMenu()
    ...
    local function Preferred_Water_Totem_DropDown_OnClick(self, arg1, arg2, checked)
        return Config:CreateTotemDropdownOnClick(self, "prefferedWaterTotem", TPConfig.dropDownTwo,
            TPConfig.dropDownIconTwo, "water");
    end
    ...
    -- init dropdowns
    self:InitDropdown(TPConfig.dropDown, TotemPredictorDropDownMenu, TotemPredictorDB["prefferedEarthTotem"][1],
        TPConfig.dropDownIcon, TotemPredictorDB["prefferedEarthTotem"][2]);
    self:InitDropdown(TPConfig.dropDownTwo, TotemPredictorDropDownMenuTwo, TotemPredictorDB["prefferedWaterTotem"][1],
        TPConfig.dropDownIconTwo, TotemPredictorDB["prefferedWaterTotem"][2]);
